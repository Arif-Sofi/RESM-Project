                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg col-span-1 md:col-span-2">
                    <div class="p-6">
                        <h3 class="font-semibold text-lg text-gray-800 dark:text-gray-200 mb-4">
                            {{ __('ようこそ、') }} {{ Auth::user()->name }} {{ __('殿') }}
                        </h3>
                        <p class="text-gray-600 dark:text-gray-400">
                            {{ __('サウジャナ・ウタマ国立学校のスクール管理システムへようこそ。ここから各種機能にアクセスできます。') }}
                        </p>
                    </div>
                </div>
            ...
            <div class="mt-6 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                            <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('ユーザー権限') }}</p>
                            <p class="font-medium text-gray-800 dark:text-gray-200">{{ Auth::user()->role ?? __('一般ユーザー') }}</p>
                        </div>
                        <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
