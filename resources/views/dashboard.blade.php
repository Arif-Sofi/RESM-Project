                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <a href="{{ route('profile.edit') }}" class="block p-3 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition">
                                <span class="text-gray-700 dark:text-gray-300">{{ __('dashboard.profile_settings') }}</span>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                            ...
                            <p class="font-medium text-gray-800 dark:text-gray-200">{{ Auth::user()->role ?? __('dashboard.minion') }}</p>
                        </div>
                        <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
