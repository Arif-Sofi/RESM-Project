<x-modal name="createEventModal" maxWidth="xl" focusable>
    <form id="createEventForm">
        <div class="px-6 py-4">
            ...
            <div class="mt-4">
                <div class="mb-3">
                    <x-input-label for="eventTitle" value="{{ __('messages.title')}}" />
                    <x-text-input id="eventTitle" class="block mt-1 w-full" type="text" name="title" required />
                    <x-input-error :messages="$errors->get('title')" class="mt-2" />
                </div>
                <div class="mb-3">
                    <x-input-label for="eventDescription" value="{{ __('messages.description')}}" />
                ...
                <div class="mb-3">
                    <x-input-label for="eventStart" value="{{ __('messages.start_date')}}" />
                ...
                <div class="mb-3">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-300">{{ __('messages.multiple_select_desc')}} </p>
