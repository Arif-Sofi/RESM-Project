                ...
                <form @submit.prevent="updateEvent()" class="space-y-6">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" @click="showEditStaffDropdown = !showEditStaffDropdown"
                            ...
                            <span x-text="(editEventData.staff.length > 0 || editEventData.showOtherStaffInput) ? getEditSelectedStaffNames() : '{{ __('messages.select_staff') }}'"></span>
                        ...
                        <div x-show="showEditStaffDropdown" @click.away="showEditStaffDropdown = false"
                            ...
                            <label class="flex items-center px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 sticky top-0 z-20">
                                <input type="checkbox" :checked="isAllEditStaffSelected()" @change="toggleAllEditStaff()"
